...
test( 'Recurses over a sub-value', () => {
  ...
  expect( instance.foo )
    .toEqual( custom.foo );
  expect( instance.bar.baz )
    .toEqual( spec.bar.baz );
} );
